 ...
 ** ***************************************/
	...
	$(document).on('ready', function(){
		...
		$('input').focusin(function(){
			$(this).closest('.form-group').siblings('.helpertext').css("opacity", "1").css("transition","all 0.8s").css("padding", "0 25px 0px").css("height","30px").css("top","-10px");
		});
		$('input').focusout(function(){
			$(this).closest('.form-group').siblings('.helpertext').css("opacity", "0").css("transition","all 0.8s").css("padding", "0 25px 0px").css("height","0px").css("top","-25px");
		});
		...
		$('.step1').appear(function() {
			$(".process").addClass("load-on");
		});
		
		$(".hide-con").addClass("vis-con");
